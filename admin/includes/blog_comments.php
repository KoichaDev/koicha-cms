<table class="table table-bordered table-hover" style="text-align: center;">
    ...
    <tbody>
        <?php 
            ...
            // Finds all the comments query from the id related to the post
            $query = "SELECT * 
                      FROM comments 
            ...
            if(!mysqli_stmt_execute($stmt)) {
                die('Query of post comments id went wrong: ' . mysqli_error($connection));
            }
            ...
            while($row = mysqli_fetch_assoc($postResult)) {
                ...
                echo "<td><a href='posts.php?source=blog_comments&approve={$comment_id}&id={$_GET["id"]}'>Approve</a></td>";
                echo "<td><a href='posts.php?source=blog_comments&unapprove={$comment_id}&id={$_GET["id"]}'>Unapprove</a></td>";
                echo "<td><a href='posts.php?source=blog_comments&delete={$comment_id}&id={$_GET["id"]}'>Delete</a></td>";
                echo "</tr>";
            }
        ?>
    </tbody>
...
<?php 
    ...
    if(isset($_GET['approve'])) {
        ...
        header("Location: posts.php?source=blog_comments&id={$_GET['id']}");
    }
